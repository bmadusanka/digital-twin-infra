...
| [aws_s3_bucket_logging.bucket_logging_partitioned_prefix](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_logging) | resource |
...
| <a name="input_project"></a> [project](#input\_project) | Specify to which project this resource belongs | `string` | n/a | yes |
...
| <a name="input_target_bucket_id"></a> [target\_bucket\_id](#input\_target\_bucket\_id) | Target bucket to push logs | `string` | n/a | yes |
| <a name="input_target_bucket_prefix"></a> [target\_bucket\_prefix](#input\_target\_bucket\_prefix) | Prefix for all log object keys. | `string` | `"log/"` | no |
| <a name="input_target_object_key_format"></a> [target\_object\_key\_format](#input\_target\_object\_key\_format) | Target object keys format. | <pre>object({<br>    enabled = optional(bool, false)<br>    partitioned_prefix = optional(object({<br>      partition_date_source = optional(string, "EventTime")<br>    }))<br>  })</pre> | <pre>{<br>  "enabled": false<br>}</pre> | no |
